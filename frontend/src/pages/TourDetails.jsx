...
const TourDetails = () => {
    ...
    const [tourRating, setTourRating] = useState(null); // Corrected destructuring
                        ...
                        <div className="tour__content">
                            ...
                            <div className="tour__info">
                                ...
                                <div className="d-flex align-items-center gap-5">
                                    <span className="tour__rating d-flex align-align-center gap-1">
                                ...
                                <ListGroup className="user__reviews">
                                    {reviews?.map((review, index) => (
                                        <div className="reviews__item">
                                            ...
                                            <div className="w-100">
                                                <div className="d-flex align-items-center justify-center-between">
                                                    <div>
                                                        <h5>muhib</h5>
                                                        <p>
